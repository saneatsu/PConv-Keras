...
# data dir
WEIGHT_PATH   = '{}/data/model/resize-1536x3072/512x512_GPU-4_Batch-7_Remove-50%white/weight/'.format(MNT_PATH)
TFLOG_PATH    = '{}/data/model/resize-1536x3072/512x512_GPU-4_Batch-7_Remove-50%white/tflogs'.format(MNT_PATH)
