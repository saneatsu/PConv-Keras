...
CROP_HEIGHT   = 256 # 256, 384, 512
CROP_WIDTH    = 256 # 512, 768, 1024
...
# data dir
WEIGHT_PATH   = '{}/data/model/resize-1536x3072/256x256_GPU-4_Batch-27_Mask-After/weight/'.format(MNT_PATH)
TFLOG_PATH    = '{}/data/model/resize-1536x3072/256x256_GPU-4_Batch-27_Mask-After/tflogs'.format(MNT_PATH)
